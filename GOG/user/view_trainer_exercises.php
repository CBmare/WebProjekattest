...
if(isset($_GET['view_trainer_exercises'])) {
    ...
    <table align="center" width="794" style="color:white;">
        ...
        $email = $_SESSION['mail'];
        $sel_user="SELECT * FROM users WHERE user_type = 'trainer'";
        ...
        $sel_exer="SELECT * FROM exercises WHERE user_id= '$user_id'";
        ...
        while ($row_exer=mysqli_fetch_array($run_exer)) {
            ...
            <tr align="center">
                ...
                <td><a href="user_page.php?add_exercises_my=<?php echo $exer_id; ?>">Add</a></td>
            </tr>
        <?php } ?>
    </table>
<?php } ?>
